...
lux_tax = Event.create!(name: 'Luxury Tax', description: 'Pay $100')
go = Event.create!(name: 'Go', description: 'Collect $200 Salary As You Pass')
...
Token.create!(name: 'boot')
Token.create!(name: 'car')
Token.create!(name: 'cat')
Token.create!(name: 'dog')
Token.create!(name: 'hat')
Token.create!(name: 'ship')
Token.create!(name: 'thimble')
Token.create!(name: 'wheelbarrow')
